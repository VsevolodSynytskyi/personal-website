...
export default function Slider() {
  ...
  return (
    <motion.div
      ...
      className="flex items-center justify-center w-full gap-3 select-none touch-none"
    >
      <motion.div
        animate={{
      ...
      >
        <motion.div
          ...
          className="flex grow"
        >
          <RadixSlider.Track className="relative h-full overflow-hidden bg-gray-500 rounded-full isolate grow ">
